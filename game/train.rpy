...
#   camera at parallax
    ...
    with fade
    n "Wow..."
    call poptearb from _call_poptearb_83
    ...
    show poprain with dissolve:
        xcenter .75
        ycenter .25
    f "Waaaaaaaaaaaaaahhhhhhhhhhhhhhhhhhhhh..."
    o "Hey Freddy, it'll be okay."
    o "We can sit together, buddy. We'll hang out right here in this train car."
...
###########################################
    ...
    show pophuh:
        ...
        xcenter .6
        ycenter .25
    i "I'll go with, the uh, pirate."
    hide pophuh
    i "Why is there a pirate here again?"
    show sid ind:
        linear .3 xcenter .75
    ...
    j "AHHHHH!"
    j "Catherine, your cat just bit me!"
    hide popwow
...
label midcar2:
    ...
    s "Anyway..."
    s "It's interesting how smooth of a ride this is."
    ...
    stop music
    play sfx "audio/beep.mp3" volume .5
    show text "{color=#fff}Attention!{/color}" with moveintop:
        ycenter .1
    pause 1
    hide text
    play sfx "audio/beep.mp3" volume .5
    show text "{color=#fff}Stand Clear of the Closing Doors!{/color}" with moveintop:
        ycenter .1
    pause 1
    ...
    ses "mowwww!"
    $mood = "shock"
    call poptearb from _call_poptearb_84
...
label frontcar1:
    ...
    scene black with fade
    blank "The 11 of them made their way to the front car, leaving only Stella in the middle car."
...
label frontcar2:
    ...
    f "I miss my mom..."
    call popwowb from _call_popwowb_105
    ...
    call pophuhb from _call_pophuhb_61
    ...
    $mood = "shock"
    call popwowb from _call_popwowb_106
    ...
    show drac oh:
        xcenter .25
    $mood = "ind"
    n "So that's the light switch..."
    b "It looks like it dims the computer screens a bit as well."
    n "Thankfully there's still a little sunlight."
    hide drac oh
    show drac ind:
        xcenter .25
...
label midcar3:
    ...
    d "There is no need."
    n "Why's that?"
    call poptearb from _call_poptearb_85
    ...
    call poptearb from _call_poptearb_86
    n "Anything... bad?"
    s "Goodnight Dan."
    hide sam with dissolve
    n "..."
    ...
    $mood = "shock"
    call popwowb from _call_popwowb_107
...
label midcar4:
    ...
    show scary:
        alpha 0
        linear .3 alpha .5
    call poptearb from _call_poptearb_87
    ni "And morale."
...
#    play sfx "audio/popwow.mp3" volume .5
    ...
    call pophuhb from _call_pophuhb_62
...
#    blank "A sharp sound suddenly filled the train car momentarily."
    ...
    b "... But..."
    $mood = "shock"
    call popwowb from _call_popwowb_108
    b "Oh no."
    j "What's wrong?"
    ...
    call poptearb from _call_poptearb_88
...
label preinvest:
    ...
    call poptearb from _call_poptearb_89
    ...
    bi "Anything could be useful, so I'll need to look around closely."
    $mood = "ind"
    pause 1
...
label trial1a:
    ...
    b "Hey wait, we don't need to argue like that!"
    t "I suppose you are just a child... let me explain."
    stop music fadeout 1.0
...
label trial1c:
    ...
    s "Are you saying Dracula was lying about the closet being locked?"
    hide jenny ind with moveoutleft
    show drac ind with moveinleft:
        xcenter .25
    ...
    d "There were some general supplies, some wood, and... the murder weapon."
    ...
    d "As well, I pushed the bed even closer up to the closet wall door, making it even more difficult to open."
    hide sam with moveoutright
    show kaiser ind with moveinright:
        xcenter .75
    ...
    show popwow:
        ...
        zoom .75
    i "Dan!"
    i "Dan was sleeping in the cot last night, and the cot blocks the closet!"
    hide popwow
    i "It won't even open if you don't move the cot a little, like Dracula said!"
    show drac ind with moveinleft:
        rotate 45
        xcenter -.1
        ycenter .5
...
label trial1d:
    ...
    python:
        ...
        "stella", "Do you think I'm {color=#0BF}making up{/color} the scream? Why would I do that?", 1,
...
label trial1e:
    ...
    d "I find it quite easy to focus in the dark, and to me, that scream felt very peculiar."
...
label trial1h:
    ...
    menu:
        ...
        "Something blocked the moonlight coming through the windows!":
            call popwowb from _call_popwowb_110
            bi "That's it!"
    ...
    hide scary with dissolve
    b "That must be it!"
    b "Something blocked all the moonlight coming through the windows."
    ...
    b "Sam mentioned the same thing yesterday."
    ...
    o "It still seems impossible for someone other than Sid to be there to do it."
    b "...That is true..."
...
label trial1i:
    ...
    call pophuhb from _call_pophuhb_63
...
label trial1ib:
    ...
    hide pophuh
    call poptearb from _call_poptearb_90
    bi "..."
    hide drac ind with moveoutleft
    show catherine happy with moveinleft:
        xcenter .25
    ...
    i "Why is the stick figure smiling now..."
    ...
    b "..."
    b "I think you're correct, though."
    hide pophearts
    ...
    t "To me, it seems easy enough."
    t "We'll have to kill them."
    k "Agreed."
    call popwowb from _call_popwowb_111
    ...
    show popmad:
        xcenter .75
        ycenter .3
    i "This tadpole's starting to bother me..."
    ...
    python:
        startTrainTrial("sid", "Sid: I know it seems like a waste, but think about what Freddy just said.{color=#0BF}{/color}", 0,
        "catherine", "Catherine: Look! I'll admit it, {color=#f00}his drawing was better than mine...{/color}", -1,
        "catherine", "Catherine: But this is a waste of time. There's {color=#0BF}nothing useful in his picture{/color} anyway.", 1,
        "sid",  "Sid: Don't you think his flag looked... {color=#0BF}awfully similar to a scythe{/color}?", 1,
        3, -1, "trial1j")
...
label trial1m:
    ...
    $mood = "shock"
    call popwowb from _call_popwowb_112
    bi "!"
    ...
    f "Someone hurt Dan even though they weren't there with him?"
    ...
    f "B-but... what? That doesn't make any sense..."
    t "Au contraire."
    hide screen status_screen
    $showchibint()
    with dissolve
...
label trial1n:
    ...
    with dissolve
    show frog ind with moveinbottom
    b "There was something that distracted him, Freddy."
    ...
    show thering with dissolve:
        xcenter .75
    b "In fact, it must have been hanging from that same hinge."
    bi "To think I missed something like that..."
    ...
    show sam ind:
        xcenter .25
    with moveinleft
    call poptearb from _call_poptearb_91
    ...
    s "Don't be so foolish, Lauren."
    hide screen status_screen
    $showchibint()
    with dissolve
    camera at paralloff
    python:
        startTrainTrial("lauren", "Lauren: Why are you {color=#0BF}so sure about yourself{/color}?", 1,
...
label trial1o:
    ...
    show scary with dissolve:
        alpha .5
    bi "I was not prepared for Jenny to do that."
...
label trial1p:
    ...
    hide scary with dissolve
    call popwowb from _call_popwowb_113
    ...
    bi "This could be it..."
    call popwowb from _call_popwowb_114
...
label trial1q:
    ...
    call popwowb from _call_popwowb_115
    ...
    k "That's exactly what I was doing, you fool."
