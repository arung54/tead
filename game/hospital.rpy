label hospitalGo:
    ...
    show sam ind with dissolve:                      #all sams need to be sam ind etc febreview
        xcenter .25
...
label hospitalb:
    ...
    b "It's still twilight, so we should have some time before we need to make food for everone."
