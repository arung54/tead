...
label frogAsk1:
    ...
    menu:
        "Spend time with Froggy":
            f "O-okay mister..."
            call frogHang from _call_frogHang
        "Maybe later":
            hide frog with dissolve
    call screen midCar with dissolve
...
label frogAsk2:
    ...
    menu:
        "Spend time with Froggy":
            ...
            call frogHang from _call_frogHang_1
        "Maybe later":
            hide frog with dissolve
...
label frogAsk3:
    ...
    menu:
        "Spend time with Froggy":
            ...
            call frogHang from _call_frogHang_2
        "Maybe later":
            hide frog with dissolve
    call screen bedroomFL with dissolve
...
label frogAsk4:
    ...
    menu:
        "Spend time with Froggy":
            ...
            call frogHang from _call_frogHang_3
        "Maybe later":
            hide frog with dissolve
...
label frogAsk5:
    ...
    menu:
        "Spend time with Froggy":
            ...
            call frogHang from _call_frogHang_4
        "Maybe later":
            hide frog with dissolve
...
label frogAsk6:
    ...
    menu:
        "Spend time with Froggy":
            ...
            call frogHang from _call_frogHang_5
        "Maybe later":
            hide frog with dissolve
...
label frogAsk7:
    ...
    menu:
        "Spend time with Froggy":
            ...
            call frogHang from _call_frogHang_6
        "Maybe later":
            hide frog with dissolve
    call screen patientcommons with dissolve
...
label frogAsk8:
    ...
    menu:
        "Spend time with Froggy":
            ...
            call frogHang from _call_frogHang_7
        "Maybe later":
            hide frog with dissolve
...
label frogAsk9:
    ...
    menu:
        "Spend time with Froggy":
            ...
            call frogHang from _call_frogHang_8
        "Maybe later":
            hide frog with dissolve
...
label frogAsk10:
    ...
    menu:
        "Spend time with Froggy":
            ...
            call frogHang from _call_frogHang_9
        "Maybe later":
            hide frog with dissolve
...
label frogAsk11:
    ...
    menu:
        "Spend time with Froggy":
            ...
            call frogHang from _call_frogHang_10
        "Maybe later":
            hide frog with dissolve
...
label frogHang:
    ...
    if fte_frog == 0:
        ...
        call showFrogSadFTE from _call_showFrogSadFTE
        f "Oh... ok..."
        ...
        call showFrogHappyFTE from _call_showFrogHappyFTE
        play sfx "audio/pophearts.mp3" volume .25
        show pophearts:
            xcenter .5
            ycenter .5
