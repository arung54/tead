...
label jennAsk1:
    ...
    menu:
        "Spend time with Jenny":
            j "Sure!"
            call jennHang from _call_jennHang
        "Maybe later":
            hide jenny with dissolve
    call screen midCar with dissolve
...
label jennAsk2:
    ...
    menu:
        "Spend time with Jenny":
            j "Sure, let's chat!"
            call jennHang from _call_jennHang_1
        "Maybe later":
            hide jenny with dissolve
...
label jennAsk3:
    ...
    menu:
        "Spend time with Jenny":
            ...
            call jennHang from _call_jennHang_2
        "Maybe later":
            hide jenny with dissolve
...
label jennAsk4:
    ...
    menu:
        "Spend time with Jenny":
            ...
            call jennHang from _call_jennHang_3
        "Maybe later":
            hide jenny with dissolve
    call screen kitchen with dissolve
...
label jennAsk5:
    ...
    menu:
        "Spend time with Jenny":
            ...
            call jennHang from _call_jennHang_4
        "Maybe later":
            hide jenny with dissolve
...
label jennAsk6:
    ...
    menu:
        "Spend time with Jenny":
            j "Sure!"
            call jennHang from _call_jennHang_5
        "Maybe later":
            hide jenny with dissolve
...
label jennAsk7:
    ...
    menu:
        "Spend time with Jenny":
            ...
            call jennHang from _call_jennHang_6
        "Maybe later":
            hide jenny with dissolve
    call screen patientcommons with dissolve
...
label jennAsk8:
    ...
    menu:
        "Spend time with Jenny":
            ...
            call jennHang from _call_jennHang_7
        "Maybe later":
            hide jenny with dissolve
...
label jennAsk9:
    ...
    menu:
        "Spend time with Jenny":
            ...
            call jennHang from _call_jennHang_8
        "Maybe later":
            hide jenny with dissolve
    call screen lobby with dissolve
...
label jennAsk10:
    ...
    menu:
        "Spend time with Jenny":
            ...
            call jennHang from _call_jennHang_9
        "Maybe later":
            hide jenny with dissolve
...
label jennAsk11:
    ...
    menu:
        "Spend time with Jenny":
            ...
            call jennHang from _call_jennHang_10
        "Maybe later":
            hide jenny with dissolve
...
label jennHang:
    ...
    #Bert FTE 1
    if fte_jenn == 0:
        call showJennyHappyFTE from _call_showJennyHappyFTE
    ...
    if fte_jenn == 1:
        call showJennyHappyFTE from _call_showJennyHappyFTE_1
        ...
        call showJennyIndFTE from _call_showJennyIndFTE_1
        j "...You don't know what it is, do you?"
        b "No, that wasn't a very convincing lie, was it."
        j "Not really, no."
        call showJennyHappyFTE from _call_showJennyHappyFTE_3
        ...
        call showJennyIndFTE from _call_showJennyIndFTE_2
    ...
    if fte_jenn == 2:
        call showJennyHappyFTE from _call_showJennyHappyFTE_4
        j "Bert!"
        ...
        call showJennyIndFTE from _call_showJennyIndFTE_3
        ...
        call showJennyHappyFTE from _call_showJennyHappyFTE_5
        ...
        call showJennyIndFTE from _call_showJennyIndFTE_4
        j "..."
        b "..."
        j "So, um..."
