label pentGo:
    ...
    call popwowb from _call_popwowb_76
    ...
    call pophuhb from _call_pophuhb_57
    ...
    call poptearb from _call_poptearb_75
    bi "Jenny? Freddy? Sid?"
    $mood = "ind"
    ...
    ses "Mrep."
    $mood = "ind"
    call pophuhb from _call_pophuhb_58
    ...
    f "mimimimimimimi....................."
    bi "..."
    call popwowb from _call_popwowb_77
    b "HEY!!!"
    b "WAKE UP!!!"
    show jenny scared:
        xcenter .3
    ...
    show frog2 smile
    $popx = .7
    call popheartso from _call_popheartso_16
...
label pent2:
    ...
    call popwowb from _call_popwowb_78
    ...
    show jenny happy
    $popx = .3
    call popheartso from _call_popheartso_17
    j "Great logic guys!"
    j "So who's who?"
    ...
    with dissolve
    $popx = .3
    call popheartso from _call_popheartso_18
    ...
    $mood = "sad"
    call poptearb from _call_poptearb_76
...
label pent23:
    ...
    $popx = .67
    call popwowo from _call_popwowo_28
    ...
    call popwowb from _call_popwowb_79
    b "Huh?!"
    ...
    call poptearo from _call_poptearo_34
    i "A little spooky."
...
label pent25:
    ...
    show sid ind with moveinright:
        xcenter .7
    i "About what?"
    call popwowb from _call_popwowb_80
    ...
    $popx = .67
    call pophuho from _call_pophuho_23
    ...
    $popx = .33
    call popwowo from _call_popwowo_29
    ...
    call popwowb from _call_popwowb_81
    b "That's it!"
    show scary with dissolve:
        alpha .5
label pent26:
    ...
    $popx = .3
    call popmado from _call_popmado_13
    j "Bert!"
    ...
    $popx = .67
    call pophuho from _call_pophuho_24
...
label pent28:
    ...
    b "For years, even?"
    $popmood = .33
    call poptearo from _call_poptearo_35
    j "Wait..."
    show jenny scared:
        linear .2 xcenter .25
...
label pent29:
    ...
    $popx = .67
    call popwowo from _call_popwowo_31
    ...
    call popwowb from _call_popwowb_82
    $mood = "shock"
    b "Hold on!"
    ...
    b "..."
    $mood = "ind"
    call poptearb from _call_poptearb_77
    b "...I think it's fine."
    ...
    $popx = .67
    call poptearo from _call_poptearo_36
...
label pent31:
    ...
    call pophuho from _call_pophuho_25
    i "Huh?"
    b "Think about it."
...
label postFT11:
    ...
    $mood = "sad"
    call poptearb from _call_poptearb_78
    ...
    call popwowb from _call_popwowb_83
    $mood = "shock"
    b "Woah!"
    i "What is it?!"
    b "Look, look!"
...
label pent33:
    ...
    show jenny happy
    $popx = .3
    call popheartso from _call_popheartso_21
    j "Good catch Bert!"
    ...
    $popx = .65
    call popwowo from _call_popwowo_32
    i "YEAH!"
    ...
    j "........"
    $popx = .35
    call popwowo from _call_popwowo_33
    i "I got it!"
...
label pent34:
    ...
    j "Huh?"
    $mood = "shock"
    call popwowb from _call_popwowb_84
    show jenny scared
    ...
    $popx = .28
    call pophuho from _call_pophuho_26
    ...
    $popx = .47
    call poptearo from _call_poptearo_37
    ...
    call popwowb from _call_popwowb_85
    b "What?!"
    ...
    $popx = .7
    call popwowo from _call_popwowo_34
    ...
    call popwowo from _call_popwowo_35
    i "Yeah, my ass!"
    b "It's true!"
    ...
    $popx = .75
    call popmado from _call_popmado_14
    i "I'll kill you."
    scene black with dissolve
    ...
    call poptearb from _call_poptearb_79
    b "Guys..."
    ...
    call popwowb from _call_popwowb_86
...
label pent345:
    ...
    b "These pills..."
    call popwowb from _call_popwowb_87
    ...
    $popx = .67
    call poptearo from _call_poptearo_38
    ...
    call popwowb from _call_popwowb_88
    ...
    $popx = .33
    call poptearo from _call_poptearo_39
    ...
    call popwowb from _call_popwowb_89
    ...
    $mood = "shock"
    call pophuhb from _call_pophuhb_59
    b "What?"
    ...
    $popx = .67
    call popwowo from _call_popwowo_36
...
label pent35:
    ...
    $mood = "shock"
    call popwowb from _call_popwowb_91
    ...
    with dissolve
    $popx = .67
    call popwowo from _call_popwowo_37
    ...
    bi "Well..."
    call pophuho from _call_pophuho_27
    ...
    b "I do."
    call popwowb from _call_popwowb_92
    ...
    call popwowb from _call_popwowb_93
    b "WIN this game."
    ...
    call popwowb from _call_popwowb_94
    ...
    i "Okay, yeah."
    $popx = .47
    call popwowo from _call_popwowo_40
    i "I'm Sid Straits!"
    ...
    call poptearo from _call_poptearo_41
    show sid happy
    ...
    call popwowo from _call_popwowo_41
    ...
    call poptearo from _call_poptearo_42
...
label pentpicker:
    ...
    call popwowb from _call_popwowb_95
...
label pentsid:
    ...
    $popx = .47
    call popwowo from _call_popwowo_42
    i "Bert, I -"
    b "It's time."
    camera:
...
label pentjenny:
    ...
    $mood = "ind"
    call popwowb from _call_popwowb_97
    ...
    j "My father?"
    call popwowb from _call_popwowb_98
    ...
    call popwowb from _call_popwowb_101
    ...
    show sid ind with moveinleft:
        xcenter .3
    $popx = .34
    call popwowo from _call_popwowo_44
...
label pentsidArun:
    ...
    b "Anyone could be lying about their last name, but both your names definitely starts with an S."
    $popx = .47
    call popwowo from _call_popwowo_45
    i "Bert, I -"
    b "It's time."
    camera:
        matrixtransform ScaleMatrix(1.0, 1.0, 1.0)*OffsetMatrix(0.0, 0.0, 0.0)*RotateMatrix(0.0, 0.0, 0.0)
...
label pentjennyArun:
    ...
    b "It's true that we were close."
    b "I'll never know if that was real or not."
    call popwowb from _call_popwowb_102
    b "Because you're the Game Master, and you die here."
    j "Bert, are you being serious?"
    b "There's no way I could be the Game Master."
    $popx = .47
    call popwowo from _call_popwowo_46
    b "You slipped up, Jenny."
    b "Just a few minutes ago, you said..."
    scene bg pentkitchenbroke at bg
    show frogsit5 at bg:
    ...
    b "But despite how often I think about the woman I killed, and the accident..."
    $mood = "ind"
    call popwowb from _call_popwowb_103
    b "I could never bring myself to share any details about her."
    b "There's no way you could have known it was a woman in the accident."
    b "I figured maybe it was a lucky guess, or part of the joke, so I had you and Sid give some words."
    b "But even with this second chance... you made the same slip up."
