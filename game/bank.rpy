label bankGo:
    ...
    $popx = .45
    call popwowo from _call_popwowo
    i "Hey, wake up Bert!"
    ...
    with moveinleft
    $popx = .72
    call poptearo from _call_poptearo
    ...
    $popx = .32
    call pophuho from _call_pophuho
    show sid ind
    i "H-huh?"
    ...
    $mood = "shock"
    call popwowb from _call_popwowb
    ...
    $popx = .45
    call pophuho from _call_pophuho_1
    ...
    $mood = "sad"
    call poptearb from _call_poptearb
    b "Or not..."
    show sam ind with moveinleft
    ...
    show lauren ind
    call poptearo from _call_poptearo_1
    ...
    call pophuhb from _call_pophuhb
    ...
    call poptearb from _call_poptearb_1
    ...
    $mood = "ind"
    call pophuhb from _call_pophuhb_1
    ...
    $popx = .45
    call popwowo from _call_popwowo_1
    j "Huh?!"
    ...
    call poptearb from _call_poptearb_2
    ...
    $popx = .5
    call popmado from _call_popmado
...
label bank2:
    ...
    b "Seems easy enough..."
    call popwowb from _call_popwowb_1
    ...
    $mood = "sad"
    call poptearb from _call_poptearb_3
    b "Oh."
    ...
    call pophuhb from _call_pophuhb_2
    b "Huh?"
    ...
    call poptearb from _call_poptearb_4
    ...
    $popx = .75
    call popmado from _call_popmado_2
    show sid mad
    ...
    call pophuhb from _call_pophuhb_3
...
label bank3:
    ...
    $popx = .3
    call popwowo from _call_popwowo_2
    $mood = "sad"
    j "That's terrifying! Maybe we can have Sid enter the passcode."
    call poptearb from _call_poptearb_5
    ...
    j "..."
    $popx = .25
    call popheartso from _call_popheartso
    ...
    call pophuhb from _call_pophuhb_4
    ...
    show jenny happy
    $popx = .75
    call popheartso from _call_popheartso_1
    ...
    call poptearb from _call_poptearb_6
    ...
    $popx = .7
    call poptearo from _call_poptearo_3
    ...
    call poptearb from _call_poptearb_7
...
label postFT8:
    ...
    $popx = .33
    call pophuho from _call_pophuho_2
    ...
    show frog happy
    $popx = .25
    call popheartso from _call_popheartso_2
    ...
    $mood = "sad"
    call poptearb from _call_poptearb_8
    ...
    show sam angry
    $mood = "shock"
    call pophuhb from _call_pophuhb_5
    stop music
    ...
    $mood = "shock"
    $popx = .45
    call pophuho from _call_pophuho_3
    ...
    $mood = "shock"
    call popwowb from _call_popwowb_2
    ...
    show geraldfile
    with dissolve
    call popwowb from _call_popwowb_3
    pause 1
    ...
    $mood = "shock"
    call popwowb from _call_popwowb_4
    ...
    call poptearb from _call_poptearb_9
    ...
    call pophuhb from _call_pophuhb_6
    b "What do you mean?"
    ...
    $popx = .3
    call popwowo from _call_popwowo_3
    ...
    show jenny scared:
        xcenter .25
    with dissolve
    call popwowo from _call_popwowo_4
    ...
    $mood = "sad"
    call pophuhb from _call_pophuhb_7
    ...
    $popx = .3
    call popwowo from _call_popwowo_5
    ...
    $popx = .27
    call poptearo from _call_poptearo_4
    $mood = "sad"
    ...
    bi "Unless he's..."
    $mood = "shock"
    call popwowb from _call_popwowb_5
    ...
    call pophuhb from _call_pophuhb_9
    bi "Huh?"
    j "Mmmmmmmmmmm. Bird."
    ...
    $mood = "sad"
    call poptearb from _call_poptearb_10
...
label bank5:
    ...
    $popx = .71
    call poptearo from _call_poptearo_5
    ...
    show frog happy
    $popx = .25
    call popheartso from _call_popheartso_3
    ...
    $popx = .3
    call pophuho from _call_pophuho_4
    ...
    show frog happy
    f "Oh! I get it."
    call poptearb from _call_poptearb_11
    ...
    call poptearb from _call_poptearb_12
    ...
    $popx = .5
    call popheartso from _call_popheartso_4
    j "That's us!"
    ...
    call popwowo from _call_popwowo_7
    ...
    call poptearb from _call_poptearb_13
    ...
    show lauren ind
    $popx = .3
    call poptearo from _call_poptearo_6
    ...
    show frog happy
    $popx = .5
    call popheartso from _call_popheartso_5
    $mood = "shock"
    f "Okay!"
    show jenny happy
    show lauren happy
    ...
    show frog2 smile
    call popheartso from _call_popheartso_6
    ...
    $popx = .3
    call poptearo from _call_poptearo_7
    ...
    call poptearb from _call_poptearb_15
    ...
    show sid happy
    $popx = .45
    call poptearo from _call_poptearo_8
...
label postFT10:
    ...
    $popx = .7
    call pophuho from _call_pophuho_5
    ...
    $popx = .3
    call poptearo from _call_poptearo_9
    ...
    $mood = "sad"
    call poptearb from _call_poptearb_16
    bi "This kid..."
    $mood = "ind"
    ...
    $popx = .5
    call popheartso from _call_popheartso_7
    f "Yay yay yay yay!"
    ...
    call poptearb from _call_poptearb_17
    ...
    call popwowb from _call_popwowb_6
    bi "Mr. Sydell."
    ...
    call popwowb from _call_popwowb_7
    ...
    $mood = "sad"
    call pophuhb from _call_pophuhb_11
    ...
    b "HEY!"
    b "..."
    call poptearb from _call_poptearb_18
    ...
    $popx = .47
    call pophuho from _call_pophuho_6
    ...
    call popwowb from _call_popwowb_8
    ...
    call popwowb from _call_popwowb_9
    b "Sam, please!"
    ...
    call poptearo from _call_poptearo_11
    ...
    call popwowb from _call_popwowb_10
    ...
    b "Yeah, and that."
    call pophuhb from _call_pophuhb_12
    ...
    call popwowo from _call_popwowo_9
    $mood = "shock"
    s "Oh!"
    ...
    call pophuhb from _call_pophuhb_13
    b "Huh?"
    ...
    $popx = .3
    call popwowo from _call_popwowo_10
    ...
    call pophuhb from _call_pophuhb_14
    b "...Understand what?"
    ...
    call popwowo from _call_popwowo_11
    ...
    b "I guess so, yeah?"
    $popx = .25
    call popheartso from _call_popheartso_8
    $mood = "sad"
    ...
    call pophuhb from _call_pophuhb_15
    ...
    $popx = .7
    call pophuho from _call_pophuho_7
    s "\"Done your part?\""
...
label bank8:
    ...
    bi "..."
    call pophuhb from _call_pophuhb_16
    bi "Huh?"
    blank "Shrrrrrrr."
    $mood = "shock"
    ...
    bi "Wait."
    call popwowb from _call_popwowb_11
    bi "Shit."
    ...
    bi "..."
    call poptearb from _call_poptearb_19
    b "No..."
    b "Not again..."
    ...
    $popx = .45
    call pophuho from _call_pophuho_8
    j "Who is it?"
    b "Huh?"
    ...
    $popx = .7
    call popwowo from _call_popwowo_12
    l "...Oh shit!"
    l "That..."
    l "Is that... Sam?"
    b "Yeah... Sam's dead."
    ...
    $mood = "ind"
    call popwowb from _call_popwowb_12
    stop music fadeout 1.0
...
label hospPreInv2:
    ...
    show jenny ind:
        xcenter .25
        linear 0.15 xcenter .5
    call pophuhb from _call_pophuhb_17
...
label trial4a:
    ...
    j "Not going to lie..."
    $popx = .3
    call poptearo from _call_poptearo_12
...
label trial4b:
    ...
    show lauren ind:
        xcenter .75
    with dissolve
    call pophuhb from _call_pophuhb_18
    ...
    call pophuhb from _call_pophuhb_19
...
label trial4d:
    ...
    call popwowb from _call_popwowb_13
    ...
    j "Hm..."
    $popx = .3
    call pophuho from _call_pophuho_9
...
label trial4f:
    ...
    $popx = .25
    call popmado from _call_popmado_4
    show sid mad:
        xcenter .25
    ...
    $popx = .3
    call pophuho from _call_pophuho_10
...
label trial4j:
    ...
    i "*pant*"
    $popx = .45
    call poptearo from _call_poptearo_13
    i "It's not budging..."
    show sid ind:
        xcenter .5
        linear 0.15 xcenter .75
    ...
    show sid mad:
        xcenter .75
    $popx = .75
    call popmado from _call_popmado_5
    i "Hey!"
    ...
    $popx = .3
    call pophuho from _call_pophuho_12
...
label trial4k:
    ...
    call pophuhb from _call_pophuhb_20
...
label trial4l:
    ...
    show jenny ind with moveinright:
        xcenter .75
    $popx = .7
    call poptearo from _call_poptearo_14
    ...
    call pophuhb from _call_pophuhb_21
    $mood = "shock"
...
label trial4m:
    ...
    $popx = .7
    call pophuho from _call_pophuho_13
    ...
    call popwowb from _call_popwowb_15
...
label trial4n:
    ...
    $popx = .3
    call poptearo from _call_poptearo_15
...
label trial4p:
    ...
    call pophuho from _call_pophuho_14
    ...
    call poptearb from _call_poptearb_20
    ...
    $popx = .3
    call popwowo from _call_popwowo_13
...
label trial4q:
    ...
    call popwowb from _call_popwowb_16
...
label trial4r:
    ...
    i "Jenny..."
    $popx = .7
    call poptearo from _call_poptearo_16
    ...
    j "..."
    show sid happy
    call poptearo from _call_poptearo_17
    ...
    $popx = .3
    call poptearo from _call_poptearo_18
...
label trial4ti:
    menu:
        b "The contradiction is..."
        "The locker room.":
            call popwowb from _call_popwowb_17
            ...
            jump trial4ti
        "The safe.":
            call popwowb from _call_popwowb_18
            b "The safe!"
            ...
            call poptearb from _call_poptearb_21
...
label trial4tii:
    ...
    menu:
        "The locker room.":
            call popwowb from _call_popwowb_19
            b "The locker room!"
            i "...The locker room?"
            ...
            jump trial4tii
        "The safe.":
            call popwowb from _call_popwowb_20
...
label trial4tiii:
    menu:
        "The locker room.":
            call popwowb from _call_popwowb_21
            b "The locker room!"
            i "...The locker room?"
            i "The one I never claimed to go into in my alibi?"
            b "Uh..."
            ...
            jump trial4tiii
        "The safe.":
            call popwowb from _call_popwowb_22
            b "The safe!"
            ...
            jump trial4tiii
        "The screaming.":
            call popwowb from _call_popwowb_23
...
label trial4u:
    ...
    show sid mad
    $popx = .45
    call pophuho from _call_pophuho_15
    i "Me?"
    ...
    call popwowb from _call_popwowb_24
    ...
    call popwowo from _call_popwowo_14
    ...
    call poptearb from _call_poptearb_22
...
label trial4v:
    ...
    call pophuho from _call_pophuho_16
...
label trial4x:
    ...
    call popwowb from _call_popwowb_25
    ...
    call popwowb from _call_popwowb_26
...
label trial4y:
    ...
    b "But Sid..."
    call popwowb from _call_popwowb_27
    b "Sid couldn't have!"
    ...
    $popx = .7
    call pophuho from _call_pophuho_17
    ...
    call poptearo from _call_poptearo_19
    ...
    $popx = .45
    call poptearo from _call_poptearo_20
    ...
    l "Never mind."
    call pophuhb from _call_pophuhb_22
...
label trial4z:
    ...
    call popwowb from _call_popwowb_28
    ...
    $popx = .45
    call pophuho from _call_pophuho_18
...
label trial4aa:
    ...
    $popx = .7
    call pophuho from _call_pophuho_19
    $mood = "shock"
...
label trial4ab:
    ...
    call popwowb from _call_popwowb_29
...
label laurAsk:
    menu:
        ...
        "Why this bank?":
            ...
            call pophuhb from _call_pophuhb_23
        ...
        "How did you open the safe?":
            ...
            call pophuhb from _call_pophuhb_24
            ...
            call poptearb from _call_poptearb_23
            ...
            $popx = .7
            call poptearo from _call_poptearo_21
        ...
        "Why Sam?" if len(menuset) >= 2:
            ...
            $popx = .75
            call popmado from _call_popmado_6
            ...
            $popx = .7
            call popwowo from _call_popwowo_15
            ...
            call popwowb from _call_popwowb_30
