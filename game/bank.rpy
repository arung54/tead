label bankGo:
    ...
    syc "Mom..."
    syc "She... she might still be alive if you were back home."
    sy "What did you say?"
    sy "How dare you pin her death on me!"
    sy "She died in an accident!"
    ...
    syc "But you could've taken care of mom after the lawsuit!"
    ...
    zg "He probably implicitly agreed to not reveal his employer if caught."
