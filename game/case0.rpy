...
label meetDracula:
    ...
    d "Hello. I'm Dracula."
    $mood = "shock"
    call pophuhb from _call_pophuhb_25
    n "...Like the vampire?"
    d "Yes."
...
label meetLauren:
    ...
    menu laurenQuestions:
        ...
        "What do you do for a living?":
            ...
            call pophuhb from _call_pophuhb_26
            ni "?"
...
label go: #Add silhouttes here?
    ...
    n "..."
    call pophuhb from _call_pophuhb_27
    n "What!?"
...
#        linear .3 xcenter .5
    $mood = "shock"
    call popwowb from _call_popwowb_31
...
label postMeetings:
    ...
    with fade
    ni "..."
    call pophuhb from _call_pophuhb_28
    ...
    stop music fadeout 1.0
    call popwowb from _call_popwowb_32
    $mood = "mad"
    ni "...what?"
