...
label sidAsk1:
    ...
    menu:
        "Spend time with Sid":
            i "Let's do it."
            call sidHang from _call_sidHang
        "Maybe later":
...
label sidAsk2:
    ...
    menu:
        "Spend time with Sid":
            ...
            call sidHang from _call_sidHang_1
        "Maybe later":
            hide sid with dissolve
...
label sidAsk3:
    ...
    menu:
        "Spend time with Sid":
            ...
            call sidHang from _call_sidHang_2
        "Maybe later":
            hide sid with dissolve
    call screen masterBedroom
...
label sidAsk4:
    ...
    menu:
        "Spend time with Sid":
            ...
            call sidHang from _call_sidHang_3
        "Maybe later":
            hide sid with dissolve
    call screen dining
...
label sidAsk5:
    ...
    menu:
        "Spend time with Sid":
            ...
            call sidHang from _call_sidHang_4
        "Maybe later":
            hide sid with dissolve
...
label sidAsk6:
    ...
    menu:
        "Spend time with Sid":
            ...
            call sidHang from _call_sidHang_5
        "Maybe later":
            hide sid with dissolve
...
label sidAsk8:
    ...
    menu:
        "Spend time with Sid":
            ...
            call sidHang from _call_sidHang_6
        "Maybe later":
            hide sid with dissolve
...
label sidAsk9:
    ...
    menu:
        "Spend time with Sid":
            ...
            call sidHang from _call_sidHang_7
        "Maybe later":
            hide sid with dissolve
...
label sidAsk10:
    ...
    menu:
        "Spend time with Sid":
            ...
            call sidHang from _call_sidHang_8
        "Maybe later":
            hide sid with dissolve
    call screen lobby with dissolve
...
label sidAsk11:
    ...
    menu:
        "Spend time with Sid":
            ...
            call sidHang from _call_sidHang_9
        "Maybe later":
            hide sid with dissolve
...
label sidHang:
    ...
    if fte_sid == 0:
        ...
        call showSidMadFTE from _call_showSidMadFTE
    ...
    if fte_sid == 1:
        ...
        call showSidSmileFTE from _call_showSidSmileFTE
    ...
    if fte_sid == 2:
        ...
        call showSidMadFTE from _call_showSidMadFTE_1
        ...
        call showSidIndFTE from _call_showSidIndFTE
        i "...Not that I'm a kid."
        call showSidMadFTE from _call_showSidMadFTE_2
        ...
        i "Hm..."
        call showSidIndFTE from _call_showSidIndFTE_1
        i "You may be right... but I still think all adults are punks."
        call showSidHappyFTE from _call_showSidHappyFTE
