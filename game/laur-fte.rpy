...
label laurAsk1:
    ...
    menu:
        "Spend time with Lauren":
            ...
            call laurHang from _call_laurHang
        "Maybe later":
            hide lauren with dissolve
    call screen midCar with dissolve
...
label laurAsk2:
    ...
    menu:
        "Spend time with Lauren":
            ...
            call laurHang from _call_laurHang_1
        "Maybe later":
            hide lauren with dissolve
...
label laurAsk3:
    ...
    menu:
        "Spend time with Lauren":
            ...
            call laurHang from _call_laurHang_2
        "Maybe later":
            hide lauren with dissolve
    call screen bedroomFL with dissolve
...
label laurAsk4:
    ...
    menu:
        "Spend time with Lauren":
            ...
            call laurHang from _call_laurHang_3
        "Maybe later":
            hide lauren with dissolve
...
label laurAsk5:
    ...
    menu:
        "Spend time with Lauren":
            ...
            call laurHang from _call_laurHang_4
        "Maybe later":
            hide lauren with dissolve
...
label laurAsk6:
    ...
    menu:
        "Spend time with Lauren":
            l "Sure."
            call laurHang from _call_laurHang_5
        "Maybe later":
            hide lauren with dissolve
...
label laurAsk7:
    ...
    menu:
        "Spend time with Lauren":
            ...
            call laurHang from _call_laurHang_6
        "Maybe later":
            hide lauren with dissolve
    call screen patientcommons with dissolve
...
label laurAsk8:
    ...
    menu:
        "Spend time with Lauren":
            ...
            call laurHang from _call_laurHang_7
        "Maybe later":
            hide lauren with dissolve
...
label laurAsk9:
    ...
    menu:
        "Spend time with Lauren":
            ...
            call laurHang from _call_laurHang_8
        "Maybe later":
            hide lauren with dissolve
...
label laurAsk10:
    ...
    menu:
        "Spend time with Lauren":
            l "Sure."
            call laurHang from _call_laurHang_9
        "Maybe later":
            hide lauren with dissolve
    call screen lobby with dissolve
...
label laurHang:
    ...
    if fte_laur == 2:
        ...
        call showLaurenHappyFTE from _call_showLaurenHappyFTE
