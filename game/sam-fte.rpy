...
label samAsk1:
    ...
    menu:
        "Spend time with Sam":
            ...
            call samHang from _call_samHang
        "Maybe later":
            hide sam with dissolve
    call screen frontCar with dissolve
...
label samAsk2:
    ...
    menu:
        "Spend time with Sam":
            s "Sure."
            call samHang from _call_samHang_1
        "Maybe later":
            hide sam with dissolve
...
label samAsk3:
    ...
    menu:
        "Spend time with Sam":
            ...
            call samHang from _call_samHang_2
        "Maybe later":
            hide sam with dissolve
...
label samAsk4:
    ...
    menu:
        "Spend time with Sam":
            ...
            call samHang from _call_samHang_3
        "Maybe later":
            hide sam with dissolve
...
label samAsk8:
    ...
    menu:
        "Spend time with Sam":
            ...
            call samHang from _call_samHang_4
        "Maybe later":
            hide sam with dissolve
...
label samAsk9:
    ...
    menu:
        "Spend time with Sam":
            ...
            call samHang from _call_samHang_5
        "Maybe later":
            hide sam with dissolve
...
label samAsk10:
    ...
    menu:
        "Spend time with Sam":
            ...
            call samHang from _call_samHang_6
        "Maybe later":
            hide sam with dissolve
    call screen lobby with dissolve
